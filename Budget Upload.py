...
credit_card_file = "credit_card_download.csv"
bank_statement_file = "bank_statement_download.csv"
...
monthly_income_df.sort_values(by='Date', ascending=False, inplace=True)
...
credit_description_to_category = {
    'Daycare': 'Childcare', 'YMCA': 'Exercise', 'MARKET BASKET': 'Groceries', 'STOP & SHOP': 'Groceries', 'SHAWS': 'Groceries', 'ALDI': 'Groceries', 'WHOLEFDS': 'Groceries', 'HANNAFORD': 'Groceries', 'TRADER JOE': 'Groceries', 'COSTCO WHSE': 'Groceries',
    'ROCHE BROTHERS': 'Groceries', 'BROTHERS MARKETPLACE': 'Groceries', 'BJS.COM': 'Groceries',
    'BJS WHOLESALE': 'Groceries', 'WEGMANS': 'Groceries', 'UBER': 'Auto/Transport', 'COSTCO GAS': 'Auto/Transport',
    'NOURIA': 'Auto/Transport', 'CUMBERLAND FARMS': 'Auto/Transport', '7-ELEVEN': 'Auto/Transport'
}
